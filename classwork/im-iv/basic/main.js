...
const colourSelector = document.querySelector('main form input[type="color"]#colourSelector');

colourSelector.addEventListener('input', function () {
  changeBgColour(colourSelector.value);
});

const toggleModeSelector = document.querySelector('main form input[type="checkbox"]#toggleModeSelector');
